...
${BuiltinLib.map(x=>`    (func $${x.name} (import "imports" "${x.name}") ${"(param i32)".repeat(x.typeSig[0].length)} (result i32))`).join("\n")}
    ...
    (func $set$firstItem (import "libset" "set$firstItem") (param $baseAddr i32) (result i32))
    (func $set$hasnext (import "libset" "set$hasnext") (param $baseAddr i32) (param $currKey i32) (result i32))
    (func $set$length (import "libset" "set$length") (param $baseAddr i32) (result i32))
    (func $set$next (import "libset" "set$next") (param $baseAddr i32) (param $currKey i32) (result i32))
    (func $set$print (import "libset" "set$print") (param $baseAddr i32) (result i32))
    (func $set$update (import "libset" "set$update") (param $newAddr i32) (param $baseAddr i32) (result i32))
