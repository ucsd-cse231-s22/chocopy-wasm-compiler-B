...
export class BasicREPL {
  ...
  async run(modules:Modules, astOpt: boolean = false, irOpt: boolean = false) : Promise<Value> {
    ...
    const [result, newEnv, newTypeEnv, newFunctions, instance, watCode] = await run(modules, config, astOpt, irOpt);
