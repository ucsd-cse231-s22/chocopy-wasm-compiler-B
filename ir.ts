...
export type Program<A> = { a?: A, funs: Array<FunDef<A>>, inits: Array<VarInit<A>>, initStrs: Array<[Array<VarInit<Type>>, Array<Stmt<Type>>]>, classes: Array<Class<A>>, body: Array<BasicBlock<A>> }
