...
2. Output/program behaviour will be easier to reason about since the concatenation
    reflects the runtime. i.e. everything in a shared global scope. Easy to debug by
    just looking through a linear source code.
